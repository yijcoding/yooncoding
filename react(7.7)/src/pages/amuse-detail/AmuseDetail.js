                    ...
                    <section className="py-3">
                        ...
                        <List style={{textDecoration:'none'}}>
                            <ul className='side-ul'>
                                ...
                                <li style={{backgroundColor: amuseY <= 5 && locaY > 30 ? 'lightblue' : null}}><a href='#list'>Amusement list</a></li>
                                <li style={{backgroundColor: locaY <= 30 ? 'lightblue' : null}}><a href='#location'>Location</a></li>
