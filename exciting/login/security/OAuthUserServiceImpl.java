...
//  원래 매서드인 loadUser 실행에 + member_id를 가져오는것을 추가했다.
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException{
		...
		final String member_id = (String) oAuth2User.getAttributes().get("login");
		final String authProvider = userRequest.getClientRegistration().getClientName();
		
//		Member memberEntity = null;
//		// member table에 유저가 존재하지 않으면 새롭게 등록 
//		if(!loginRepository.existsByMember_id(member_id)) {
//			System.err.println("OAuthUserServiceImpl/loadUser/ loginRepository / existsByMember_id / membertable에 member_id 존재안함");
...
//		}
		...
		log.info("Successfully pulled user info member_id {} authProvider {}",member_id,authProvider);
