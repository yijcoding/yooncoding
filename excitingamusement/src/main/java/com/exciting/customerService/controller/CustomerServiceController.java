...
public class CustomerServiceController {
	...
	public Page<AnnouncementDTO> Announcement(AnnouncementDTO announcementDTO, @RequestParam Map<String, Object> map) {
		...
		Page<AnnouncementEntity> announcementList = service.getAnnouncementList(entity, pageNum);
		...
		Page<AnnouncementDTO> pageList = new PageImpl<>(announcementDTOList, pageable, announcementList.getTotalElements());
