...
public class BoardPage {
	public static String pagingStr(int totalCount, int pageSize, int blockPage,
		...
		if (pageTemp != 1) {
			pagingStr += "<span class=page-item><a class=page-link href='" + reqUrl + "?pageNum=1&search="+search+"&select="+select+"&b_type="+b_type+"'><</a></span>";
			pagingStr += "&nbsp;";
			pagingStr += "<span class=page-item><a class=page-link href='" + reqUrl + "?pageNum=" + (pageTemp - 1)+ "&search="+search+"&select="+select+"&b_type="+b_type+"'><<</a></span>";
		}
		...
		if (pageTemp <= totalPages) {
			pagingStr += "<span class=page-item><a class=page-link href='" + reqUrl + "?pageNum=" + pageTemp+"&search="+search+"&select="+select+"&b_type="+b_type+"'>></a></span>";
			pagingStr += "&nbsp;";
			pagingStr += "<span class=page-item><a class=page-link href='" + reqUrl + "?pageNum=" + totalPages+"&search="+search+"&select="+select+"&b_type="+b_type+"'>>></a></span>";
		}
