...
<body>
	...
	<div class="customerMove">
		...
		<div class="tab_wrap" >
				<div class="tab">
					<ul class="tabs">
						<li class="tab-link current" id="li-0"><a href="/customer/faq">전체</a></li>
						<li class="tab-link" id="li-1"><a href="/customer/faq?f_type=1">이용정보</a></li>
						<li class="tab-link" id="li-2"><a href="/customer/faq?f_type=2">우대정보/이벤트</a></li>
						<li class="tab-link" id="li-3"><a href="/customer/faq?f_type=3">예매</a></li>
						<li class="tab-link" id="li-4"><a href="/customer/faq?f_type=4">기타</a></li>
					</ul>
				</div>
			</div>
